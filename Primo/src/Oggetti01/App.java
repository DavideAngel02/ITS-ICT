...
//		}
//		
//		System.out.println("Quale Camera vuoi prenotare o liberare? ");
...
//				esiste = true;
//			}
//			else if (prenotazione == listaCamere[i].numero && listaCamere[i].occupata == true) {
//				listaCamere[prenotazione - 1].occupata = false;
//				esiste = true;
//			}			
//			
//		if (!esiste)
